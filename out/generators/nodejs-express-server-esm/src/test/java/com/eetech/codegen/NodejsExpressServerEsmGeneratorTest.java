 ...
 * 1) Set a break point in NodejsExpressServerEsmGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class NodejsExpressServerEsmGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("nodejs-express-server-esm") // use this codegen library
              ...
              .setOutputDir("out/nodejs-express-server-esm"); // output directory
